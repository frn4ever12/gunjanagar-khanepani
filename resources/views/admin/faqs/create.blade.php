            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mb-3">
                        ...
                        <input type="text" name="question_ne" class="form-control @error('question_ne') is-invalid @enderror" value="{{ old('question_ne') }}" required>
                        @error('question_ne')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mb-3">
                        ...
                        <textarea name="answer_en" class="form-control @error('answer_en') is-invalid @enderror" rows="5" required>{{ old('answer_en') }}</textarea>
                        @error('answer_en')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mb-3">
                        ...
                        <textarea name="answer_ne" class="form-control @error('answer_ne') is-invalid @enderror" rows="5" required>{{ old('answer_ne') }}</textarea>
                        @error('answer_ne')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
